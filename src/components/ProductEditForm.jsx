      ...
      {isLoading ? (
        ...
        <div className=" flex flex-col gap-3  p-5">
          ...
          >
            ...
            <button className=" border flex justify-center items-center gap-3 border-stone-800 hover:bg-stone-700 active:bg-stone-600 duration-200 bg-stone-800 text-stone-50 rounded-full py-1 w-1/2 mx-auto  mt-2">
              Update Product{" "}
              {sending && (
